...
class ExploreView extends GetView<ExploreController> {
              ...
              child: SizedBox(
                ...
                child: CustomScrollView(
                  ...
                  slivers: [
                    ...
                    // ── Trending ─────────────────────────────
                    SliverToBoxAdapter(child: _buildSectionTitle('🔥 Trending Hari Ini')),
                    SliverToBoxAdapter(child: _buildTrendingSection(isTablet)),
                    // ── Featured Creators ────────────────────
                    SliverToBoxAdapter(child: _buildSectionTitle('⭐ Creator Populer')),
                    SliverToBoxAdapter(child: _buildCreatorsSection(isTablet)),
                    // ── Kategori Nusantara ───────────────────
                    SliverToBoxAdapter(child: _buildSectionTitle('🍜 Jelajahi Nusantara')),
                    SliverToBoxAdapter(child: _buildKategoriGrid(isTablet, isDesktop)),
                    // ── Resep Terbaru ────────────────────────
                    SliverToBoxAdapter(child: _buildSectionTitle('🆕 Resep Terbaru')),
                    SliverToBoxAdapter(child: _buildTerbaruSection(isTablet, isDesktop)),
  ...
  static const _kategoris = [
    {'label': 'Jawa', 'emoji': '🍚', 'gradient': [Color(0xFFFF9A5C), Color(0xFFFF6B6B)]},
    {'label': 'Sumatera', 'emoji': '🌶', 'gradient': [Color(0xFF43E97B), Color(0xFF38F9D7)]},
    {'label': 'Bali', 'emoji': '🏝', 'gradient': [Color(0xFF4FACFE), Color(0xFF00F2FE)]},
    {'label': 'Sulawesi', 'emoji': '🐟', 'gradient': [Color(0xFFA18CD1), Color(0xFFFBC2EB)]},
    {'label': 'Papua', 'emoji': '🌿', 'gradient': [Color(0xFFFFD200), Color(0xFFF7971E)]},
    {'label': 'Kalimantan', 'emoji': '🌳', 'gradient': [Color(0xFF96FBC4), Color(0xFFF9F586)]},
  ];
    ...
    return Padding(
      ...
      child: GridView.builder(
        ...
        itemBuilder: (context, i) {
          ...
          return GestureDetector(
            onTap: () =>
                controller.toKategoriProvinsi(k['label'] as String),
            child: Container(
              decoration: BoxDecoration(
