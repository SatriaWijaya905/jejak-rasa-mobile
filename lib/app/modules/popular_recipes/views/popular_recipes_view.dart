...
class PopularRecipesView extends GetView<PopularRecipesController> {
      ...
      body: Obx(() {
        ...
        if (controller.recipes.isEmpty) {
          return _EmptyState(
            ...
            title: 'Belum ada resep populer',
            subtitle: 'Coba lagi nanti atau jelajahi resep lainnya.',
          );
        }
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      const Icon(Icons.access_time, size: 14, color: _accent),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: LinearGradient(
                  colors: [_accent.withOpacity(0.14), const Color(0xFFFFF3E0)],
                ),
              ),
              child: Icon(icon, size: 44, color: _accent.withOpacity(0.85)),
            ),
